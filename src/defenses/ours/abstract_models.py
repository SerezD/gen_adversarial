...
class HLDefenseModel(ABC):
    ...
    def __init__(self, classifier: BaseClassificationModel, autoencoder_path: str,
                 ...
                 initial_noise_eps: float = 0.0, apply_gaussian_blur: bool = False, device: str = 'cpu',
        ...
        :param alpha_attenuation: in some fine-grained cases, like identities, uniformly reduce the range of alphas
        from [0, 1] to [0, attenuation]. This ensures less aggressive modifications, while maintaining the monotonic
        relationship.
        ...
        self.interpolation_alphas = [a * alpha_attenuation for a in interpolation_alphas]
    ...
    def add_gaussian_noise(self, x: torch.Tensor):
        ...
        x_noisy = (x + scaled_noise).clamp(0., 1.)
