...
from src.hl_autoencoders.StyleGan_Trans.models.encoders.helpers import get_blocks, bottleneck_IR, bottleneck_IR_SE
from src.hl_autoencoders.StyleGan_Trans.models.transformer import TransformerDecoderLayer
...
class GradualStyleEncoder(Module):
    def __init__(self, num_layers, mode='ir', opts=None):
        ...
        self.z = nn.Parameter(torch.randn(1, 16, 512))
