...
from src.hl_autoencoders.StyleGan_Trans.models.encoders.style_transformer_encoders import GradualStyleEncoder
from src.hl_autoencoders.StyleGan_Trans.models.stylegan2.model import Generator
...
class StyleTransformer(nn.Module):
	...
	def load_weights(self):
		if self.opts.checkpoint_path is not None:
			...
			self.encoder.load_state_dict(get_keys(ckpt, 'encoder.module'), strict=True)
			self.decoder.load_state_dict(get_keys(ckpt, 'decoder.module'), strict=True)
